...
const senderKeys: KeyInfo = {
  address: 'X-fuji13cf7at3422fzvgzqhxpeh7f78uuwzscyfj5dcw',
  publicKey: '8Qscn24QegqUFYhZH9E9YCTA3b3SGC9GaHfsrHSHYkkwxppUrD',
  privateKey: 'PrivateKey-NGwFHUi35MoWiXYqJpKpPfFUZ71KvwRjDpTR3stwetoCjVwnT',
};
const assetID = "8GwtWbSPTxYtp4Ara7jL6aGBTZ9xn68QffmPLwiNs1kk9jWff"; // the transaction ID is used as asset ID
const friendsAddress = 'X-fuji1wwwmqmqjhd4akrcm6wc9svvuyqw6yu5pngcu7s'; // address format is Bech32
// ============ Main Part of Script ===================
